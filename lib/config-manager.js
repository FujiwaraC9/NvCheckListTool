...
const ConfigManager = (function () {
  ...
  // 云端默认配置地址（GitHub Pages 部署后会自动指向同仓库 raw 文件）
  // 本地调试时会回退到同目录下的 config/default-checklist.json
  const CLOUD_URLS = [
    // GitHub Pages 部署后
    'https://raw.githubusercontent.com/eamon-yang_Quectel/NvCheckList/main/config/default-checklist.json',
    // GitHub Pages CDN 备用
    'https://cdn.jsdelivr.net/gh/eamon-yang_Quectel/NvCheckList@main/config/default-checklist.json',
    // 本地/相对路径（离线开发或 launch.bat 直接打开）
